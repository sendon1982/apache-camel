...
public class OrderEntity implements Serializable
{
	...
	public OrderEntity(long id, CustomerEntity customer, String orderNumber, Date timeOrderPlaced, Date lastUpdate, String status)
	{
		this.id = id;
	...
	public OrderEntity(long id, CustomerEntity customer, String orderNumber, Date timeOrderPlaced, Date lastUpdate, String status, Set<OrderItemEntity> orderItems)
	{
		this.id = id;
		this.customer = customer;
		this.orderNumber = orderNumber;
